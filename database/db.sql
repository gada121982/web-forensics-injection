...
(
    ...
    constraint fk_log_getcoinUser foreign key(id_user)
    references phapchung.user(id),

    constraint fk_log_getcoinInfocoin foreign key(id_coin)
    references phapchung.infocoin(id)
);
...
(
    ...
    constraint fk_warehouseProduct foreign key(id_product)
    references phapchung.product(id),

    constraint fk_warehouseUser foreign key(id_user)
    references phapchung.user(id)
);
