...
var authMember = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var connection, token, e_1, checkUser, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.trys.push([4, 6, , 7]);
                return [4 /*yield*/, convertAsyncAwait_1.query(connection, user_query_1.default.checkMemberExist, [
                        token,
                    ])];
            case 5:
                checkUser = _a.sent();
